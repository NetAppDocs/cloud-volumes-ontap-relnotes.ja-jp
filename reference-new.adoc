...
NOTE: AWSの場合、Cloud Volumes ONTAP 9.18.1 P2は、導入およびアップグレードのための標準バージョンです。9.18.1より古いバージョンやパッチはサポートされていません。
...
NOTE: このバージョンは、AWSへのデプロイおよびアップグレードには対応していません。
...
NOTE: このバージョンは、Amazon Web Services (AWS) へのデプロイおよびアップグレードには対応していません。
